    ...
    <Section id="features">
      <Container>
        <SectionHeading
          ...
          sub="Generation and editing usually live in different tools. Kino puts them on the same canvas — nothing gets exported, re-imported, or lost in between."
        />
    ...
    <Section id="testimonials" className="border-y border-mk-border bg-mk-surface/40">
      <Container>
        <SectionHeading
          ...
          sub="Kino helps creators produce amazing content quickly — here's what a few of them say."
          action={<Button href="/login">Try online</Button>}
        />
