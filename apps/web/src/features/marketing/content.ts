...
export const PRICING = [
  {
    ...
    cta: "Start free",
    highlight: false,
    features: ["100 free credits every month", "Canvas + timeline editor", "AI Clips — pay with credits", "Free-tier models", "720p exports", "Community support"],
  },
  {
    name: "Pro",
    price: "$24",
    ...
    cta: "Go Pro",
    highlight: true,
    features: ["Everything in Free", "2,500 credits every month", "Premium models (Veo, Kling & more)", "AI Clips + auto-schedule, no watermark", "1080p HD exports, no watermark", "Priority generation queue", "Email support"],
  },
  {
    name: "Studio",
    price: "Custom",
