...
// provider = which OAuth flow connects it (instagram + facebook share Meta)
const PLATFORMS = [
  ...
  { key: "x", name: "X", provider: null, bg: "bg-white text-black", icon: Glyph("M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.41l-5.8-7.58-6.64 7.58H.46l8.6-9.83L0 1.15h7.59l5.24 6.93zm-1.29 19.5h2.04L6.49 3.24H4.3z") },
  { key: "linkedin", name: "LinkedIn", provider: null, bg: "bg-[#0A66C2] text-white", icon: Glyph("M6.94 8.5v12H3.56v-12h3.38zM7.07 5.25a1.82 1.82 0 1 1-1.83-1.82 1.82 1.82 0 0 1 1.83 1.82zM20.5 13.9v6.6h-3.37v-6.2c0-1.56-.56-2.62-1.96-2.62a2.11 2.11 0 0 0-1.98 1.41 2.64 2.64 0 0 0-.13.94v6.47H9.68v-12h3.38v1.71a3.35 3.35 0 0 1 3.04-1.68c2.22 0 3.9 1.45 3.9 4.57z") },
] as const;
