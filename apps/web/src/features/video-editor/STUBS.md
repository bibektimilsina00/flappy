...
- [ ] **AI Tools** list remaining: Remove Filler Words, AI Background Expand, Magic B-Roll, AI Transitions, Face Filter (each = one `clip_ops._OPS` entry + a model)
