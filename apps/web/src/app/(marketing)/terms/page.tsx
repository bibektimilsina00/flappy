...
export const metadata: Metadata = {
  ...
  description: "The terms that govern your use of Flappy.",
};
...
export default function TermsPage() {
  return (
    <Legal title="Terms of Service" updated="July 30, 2026">
      <section>
        <p>
          These Terms of Service ("Terms") govern your access to and use of the Flappy website and application (the
          "Service"), operated by Flappy ("we", "us"). By creating an account or using the Service you agree to these
      ...
      <section>
        <h2>1. The Service</h2>
        <p>
          Flappy is an AI video studio: it generates media with third-party AI models, provides a canvas and video
      ...
      <section>
        ...
        <ul>
          <li>Connecting a social account authorizes Flappy to publish to that account only when you initiate a post or configure a posting schedule.</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Free-plan output may include a Flappy watermark.</li>
