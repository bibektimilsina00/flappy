...
export const metadata: Metadata = {
  title: "Blog",
  description: "Tutorials, product news, and guides from the Flappy team.",
};
  ...
  return (
    <>
      <Section className="pb-8 pt-16 sm:pt-20">
        <Container>
          <SectionHeading eyebrow="Blog" title="Tutorials, news, and guides." sub="How to get the most out of Flappy — plus what we're building next." />
        </Container>
      </Section>
