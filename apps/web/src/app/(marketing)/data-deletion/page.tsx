...
export default function DataDeletionPage() {
  return (
    <Legal title="Data Deletion Instructions" updated="July 30, 2026">
      <section>
        <p>
          You are always in control of the data Riocut stores. There are three levels of deletion, depending on what
          you want removed:
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>Open any clip in Riocut → <strong>Publish</strong> → hover the account chip → click the <strong>×</strong> to disconnect.</li>
          <li>The stored tokens are deleted immediately and any scheduled auto-posts to that account will no longer run.</li>
          <li>
            You can additionally revoke Riocut from the platform's side: Google{" "}
      ...
      <section>
        ...
        <p>
          ...
          removing your Riocut data — manage it on the platform directly.
        </p>
      </section>
    </Legal>
  );
