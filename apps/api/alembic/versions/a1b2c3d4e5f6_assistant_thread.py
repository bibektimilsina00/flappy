...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_assistant_thread_workspace_id"), "assistant_thread", ["workspace_id"], unique=False
    )
    op.create_index(
        op.f("ix_assistant_thread_workflow_id"), "assistant_thread", ["workflow_id"], unique=False
    )
